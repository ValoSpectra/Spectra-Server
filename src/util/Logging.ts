...
class Logging {
  ...
  info(data: any) {
    if (this.localLogLevel >= 1) this.log(data, Logging.colorInfo);
    return data;
  }

  debug(data: any) {
    if (this.localLogLevel >= 2) this.log(data, Logging.colorDebug);
    return data;
  }

  error(data: any) {
    if (this.localLogLevel >= 0) this.log(data, Logging.colorError);
    return data;
  }
}
